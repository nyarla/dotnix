{ stdenv, fetchFromGitHub, fetchpatch, cmake, makeWrapper, pkg-config, boost
, cudatoolkit_11_5, jsoncpp, mesa, ocl-icd, opencl-headers, opencl-info, openssl
}:
